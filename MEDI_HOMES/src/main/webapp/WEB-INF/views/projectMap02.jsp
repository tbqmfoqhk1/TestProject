...
<article class="article">    
					    			...
					    			<div class="search_hospital" >
					    				<div class="info">
					    					<div class="title">
						    					...
						    					<div class="num">${ i.instruments }</div>
						    				</div>
						    				<div class="location">
						    					<div class="address">${ i.area }</div>
						    				</div>
						    			</div>
						   				<div class="pic">
						   					<img src="resources/images/hospital/${ i.img }" >
						   				</div>
						   			</div>
	...
	<div class="pageNum">
			<c:if test="${ startPage > pageGroup }">
				<a href="projectMap02?pageNum=${ startPage - pageGroup }&keyword=${ keyword }">←</a>
			</c:if>
			<c:forEach var="i" begin="${ startPage }" end="${ endPage }">
				...
				<c:if test="${ i != currentPage }">
					<a href="projectMap02?pageNum=${ i }&keyword=${ keyword }">${ i }</a>
				</c:if>
			</c:forEach>

			<c:if test="${ endPage < pageCount }">
				<a href="projectMap02?pageNum=${ startPage + pageGroup }
				&keyword=${ keyword }">→</a>
			</c:if>
		</div>
...
var positions = [
    {
        content: '<div>${ i.name }</div>', 
        latlng: new kakao.maps.LatLng(${ i.lat }, ${ i.log })
    }
];
